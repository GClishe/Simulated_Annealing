...
#Tunable parameters
dataName = 'Ptest_100'         #Name of netlist file. Need to add .py to the end of provided files. Make sure original folder names are used and that result folders exist
